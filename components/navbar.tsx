    ...
    >
      <div
        className={`flex items-center transition-all duration-300 ${
          isScrolled ? "px-4 sm:px-6 py-2 sm:py-3 justify-between" : "px-4 sm:px-6 py-3 sm:py-4 justify-between"
        }`}
      >
        {/* Left - Logo */}
        <div className="relative h-8 sm:h-10 w-30 sm:w-28 overflow-visible flex items-center">
          <Link href="/" className="block relative h-16 sm:h-20 w-32 sm:w-40">
            <Image src="/medikloud_logo2.png" alt="Logo" fill className="object-contain" priority />
          </Link>
        </div>
